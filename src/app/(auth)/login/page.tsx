    ...
    if (validate()) {
      ...
      try {
        ...
        if (err.code === "auth/invalid-credential" || err.code === "auth/user-not-found" || err.code === "auth/wrong-password") {
          ...
          setGeneralError(err.message || "Gagal masuk. Coba lagi.");
        }
      } finally {
        setLoading(false);
      }
    ...
    <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md rounded-2xl glass-dark border border-zinc-800/80 p-8 shadow-2xl flex flex-col gap-6 relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-300">
        ...
        <div className="flex flex-col items-center text-center gap-2">
          ...
          <p className="text-xs text-zinc-500">Sign in to sync your watchlist & history</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex justify-end -mt-1">
            <Link
              ...
              className="text-xs text-zinc-400 hover:text-accent font-medium transition-colors"
            >
              Forgot Password?
            </Link>
          </div>
